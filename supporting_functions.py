...
# id = extract_video_id("https://www.youtube.com/watch?v=9wmImImmgcI")
# transcript = get_transcript(id, "hi")
# final_output = translate_transcript(transcript=transcript)
# final = get_important_topics(final_output)
# print(final)
...
# Function to create embeddings and store it into a vector store
# def create_vector_store(docs):
#     embedding = GoogleGenerativeAIEmbeddings(
#         model="models/embedding-001", transport="grpc"
#     )
